...
public class CatanBoardGeneratorIdea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catan_board_generator_idea);
        catanpara = (ScrollView)findViewById(R.id.catanParagraph);
        catanparag = (TextView)findViewById(R.id.scrolltext);
        catanparag.setText(BoardGeneratorPage[0]);

        catantitle = (TextView)findViewById(R.id.catanTitle);
        catantitle.setText(BoardGeneratorPage[2]);

        setoptions = (Button)findViewById(R.id.nextCatanButton);
        setoptions.setText(BoardGeneratorPage[1]);


    }
    public void optionExamples(View view) {
        Intent intent = new Intent(this, CatanSecond.class);
