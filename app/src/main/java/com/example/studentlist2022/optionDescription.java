...
public class optionDescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int i = Integer.parseInt(intent.getStringExtra(CatanSecond.THING));
        catanImage = (ImageView)findViewById(R.id.catanimage);
        Log.e("TAG", String.valueOf(i));

        optionsText = (TextView)findViewById(R.id.scrolltext);
