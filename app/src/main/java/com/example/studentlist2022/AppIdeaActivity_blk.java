...
public class AppIdeaActivity_blk extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    String [] appList = {
            "NailTime",
            "Macro Counter: Take a photo of your plate and it returns the nutrition facts.",
            "BoatBar:Menu app exclusively for a boat-restaurant"
    };
...
/** to here works!! do not change anything above this !!! **/
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (appSelected.equals("NailTime"))
        {
            ...
            Intent intent = new Intent(context, specialapp_blk.class);
            context.startActivity(intent);
            blkList.setSelector(R.color.darker_pink);
        }
