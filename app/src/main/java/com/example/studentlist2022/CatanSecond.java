...
public class CatanSecond extends AppCompatActivity implements AdapterView.OnItemClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catan_second);

        optionsAvailable = (ListView)findViewById(R.id.simpleListView);
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, R.layout.activity_single_list_item, R.id.textViewInLists, optArray);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l)
    {
        ...
        Intent gotopage = new Intent(context, optionDescription.class);
